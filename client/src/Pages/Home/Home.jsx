...
export default function Home(){
    ...
    const Re_search=recommend.results.map(data=>{
      return(      
        <Res
          {...data}
        />
    ...
    return(
        <div>
            {/* {modal && <div className="fixed w-full h-screen bg-neutral-gray z-10">
                <button className="fixed right-5 border border-black px-4 py-2 text-5xl font-bold text-red-600" onClick={handleModal}>X</button>
